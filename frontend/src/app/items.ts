...
export class Items {
  ...
  public static getFieldDescriptions() {
    return {
      ...
      "UNK193": "",
      "purity": "",
      "evoitem": "Set this to 1 when the item is part of an evolving item chain.",
      "evoid": "Shared evolution chain id used to tie all levels of an evolving item together.",
      "evolvinglevel": "The level position of this item inside its evolving chain.",
      "evomax": "The total number of levels configured for this evolving item chain.",
