export const ROUTE = {
  ...
  ADMIN_CHARACTER_ACHIEVEMENTS: "/admin/character-achievements",
  ADMIN_INVENTORY_KEYRING: "/admin/inventory-keyring",
  ADMIN_CHAT_ADMINISTRATION: "/admin/chat-administration",
  ...
  TRADESKILL_VIEW: "/tradeskills/:tradeskillId",
  TRADESKILL_RECIPE_EDIT: "/tradeskills/:tradeskillId/recipe/:recipeId",
  MERCHANTS: "/merchants",
