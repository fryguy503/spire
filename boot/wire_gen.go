...
func InitializeApplication() (App, error) {
	...
	taskClassRestrictionsController := controllers.NewTaskClassRestrictionsController(resolver, userEvent)
	factionEditorController := controllers.NewFactionEditorController(resolver, userEvent)
	contentFlagEditorController := controllers.NewContentFlagEditorController(resolver, userEvent)
	alternateCurrencyEditorController := controllers.NewAlternateCurrencyEditorController(resolver, userEvent)
	itemKinboundController := controllers.NewItemKinboundController(resolver, userEvent)
	achievementEditorController := controllers.NewAchievementEditorController(resolver, userEvent)
	mailParcelsEditorController := controllers.NewMailParcelsEditorController(resolver, userEvent)
	mercenaryEditorController := controllers.NewMercenaryEditorController(resolver, userEvent)
	playerOperationsController := controllers.NewPlayerOperationsController(resolver, userEvent)
	inventoryKeyringController := controllers.NewInventoryKeyringController(resolver, userEvent)
	dataBucketEditorController := controllers.NewDataBucketEditorController(resolver, userEvent)
	qGlobalEditorController := controllers.NewQGlobalEditorController(resolver, userEvent)
	chatAdministrationController := controllers.NewChatAdministrationController(resolver, userEvent)
	...
	currentUserController := permissions.NewCurrentUserController(resolver, service)
	...
	bootAppControllerGroups := provideControllers(helloWorldController, controller, meController, analyticsController, connectionsController, taskClassRestrictionsController, factionEditorController, contentFlagEditorController, alternateCurrencyEditorController, itemKinboundController, achievementEditorController, mailParcelsEditorController, mercenaryEditorController, playerOperationsController, inventoryKeyringController, dataBucketEditorController, qGlobalEditorController, chatAdministrationController, questapiController, appController, queryController, clientfilesController, staticMapController, eqemuanalyticsController, authedController, eqemuchangelogController, spirechangelogController, assetsController, permissionsController, currentUserController, userController, settingsController, eqemuserverController, publicController, eqemuserverconfigController, backupController, websocketController, systemController, modelsController)
